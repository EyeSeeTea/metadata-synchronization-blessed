...
export const includeExcludeRulesFriendlyNames: Dictionary<string> = {
    ...
    "visualizations.programIndicators": "Program indicators of visualizations",
    "visualizations.indicators": "Indicators of Visualizations",
    "visualizations.indicators.indicatorTypes": "Indicator types of indicators in visualizations",
    "visualizations.organisationUnitGroupSets": "Organisation unit group sets of visualizations",
    "visualizations.organisationUnitGroups": "Organisation unit groups of visualizations",
    "visualizations.categoryOptionGroupSets": "Category option group sets of visualizations",
    "visualizations.categoryOptionGroups": "Category option groups of visualizations",
    "visualizations.dataElementGroupSets": "Data element group sets of visualizations",
    "visualizations.dataElementGroups": "Data element groups of visualizations",
    "visualizations.dataElements": "Data elements of visualizations",
    "visualizations.dataElements.programIndicators": "Program indicators of data elements in visualizations",
    "visualizations.indicators.programIndicators": "Program indicators of indicators in visualizations",
    "visualizations.indicators.dataElements": "Data elements of indicators in visualizations",
    ...
    "maps.mapViews.indicators.indicatorTypes": "Indicator types of indicators in maps",
    "maps.mapViews.legendSets": "Legend sets of maps",
    reports: "Reports",
    reportTables: "Report Tables",
    "reportTables.legendSets": "Legend sets of Report Tables",
    "reportTables.programIndicators": "Program indicators of Report Tables",
    "reportTables.indicators": "Indicators of Report Tables",
    "reportTables.indicators.indicatorTypes": "Indicator types of indicators in Report Tables",
    "reportTables.organisationUnitGroupSets": "Organisation unit group sets of Report Tables",
    "reportTables.organisationUnitGroups": "Organisation unit groups of Report Tables",
    "reportTables.categoryOptionGroupSets": "Category option group sets of Report Tables",
    "reportTables.categoryOptionGroups": "Category option groups of Report Tables",
    "reportTables.dataElementGroupSets": "Data element group sets of Report Tables",
    "reportTables.dataElementGroups": "Data element groups of Report Tables",
