...
export function givenABuilderWithProgramType(options: {
...
export function getProgramMetadata(): Program {
    return {
        code: "program_TP_test",
        name: "program TP test",
        created: "2025-03-26T09:48:12.046",
        lastUpdated: "2025-03-27T19:47:15.233",
        translations: [],
        createdBy: {
            id: "xE7jOejl9FI",
            code: null,
        ...
        displayShortName: "program TP test",
        displayFormName: "program TP test",
        displayName: "program TP test",
        access: {
            manage: true,
            externalize: true,
            write: true,
        ...
        programTrackedEntityAttributes: [
            {
                name: "program TP test Age (years)",
                created: "2025-03-27T19:47:15.136",
                lastUpdated: "2025-03-27T19:47:15.233",
                translations: [],
                favorites: [],
                sharing: {
                ...
                displayShortName: "program TP test Age (years)",
                displayName: "program TP test Age (years)",
                access: {
                    manage: true,
                    externalize: true,
                    write: true,
...
export function getTrackedEntityTypeMetadata(): TrackedEntityType {
    return {
        name: "Lab sample",
        ...
        id: "kIeke8tAQnd",
        attributeValues: [],
    } as unknown as TrackedEntityType;
}

export function getProgramStageMetadata(): ProgramStage {
    return {
        name: "Program stage with section",
        created: "2025-03-26T09:48:12.032",
        lastUpdated: "2025-03-27T19:47:15.187",
        translations: [],
        createdBy: {
            id: "xE7jOejl9FI",
            code: null,
        ...
        programStageDataElements: [
            {
                created: "2025-03-27T19:47:15.222",
                lastUpdated: "2025-03-27T19:47:15.222",
                translations: [],
                favorites: [],
                sharing: {
                    external: false,
        ...
        referral: false,
        formType: "DEFAULT",
        displayFormName: "Program stage with section",
        displayName: "Program stage with section",
        access: {
            manage: true,
            externalize: true,
            write: true,
...
export function getDataElementProgramMetadata(): DataElement {
    return {
        name: "Fever",
        created: "2016-05-04T22:14:24.600",
        lastUpdated: "2019-08-21T13:08:02.031",
        translations: [
            {
                locale: "km",
                property: "FORM_NAME",
                value: "រោគសញ្ញាញាក់ គ្រុនក្តៅ",
            },
            {
                locale: "km",
                property: "NAME",
        ...
        shortName: "Fever",
        description: "Does the case have fever or not",
        ...
        dimensionItem: "rzhHSqK3lQq",
        displayShortName: "Fever",
        displayDescription: "Does the case have fever or not",
        displayName: "Fever",
        access: {
            manage: true,
            externalize: true,
...
export function getTrackedEntityAttributeMetadata(): TrackedEntityAttribute {
    return {
        name: "Age (years)",
        created: "2016-05-04T21:49:18.915",
        lastUpdated: "2019-08-21T13:08:05.059",
        translations: [
            {
                locale: "km",
                property: "SHORT_NAME",
        ...
        skipSynchronization: false,
        optionSetValue: false,
        dimensionItem: "B6TnnFMgmCk",
        displayShortName: "Age (years)",
        displayDescription: "Age in years",
...
export function getProgramMetadataByIdsResponsesWithIncludeAll(): Record<ResponseNumber, MetadataPackage> {
    return {
        first: {
            programs: [getProgramMetadata()],
        },
        second: {
            users: [
                {
                ...
                },
                {
                    ...
                    lastUpdated: "2025-03-27T19:39:03.637",
                    translations: [],
                    createdBy: {
                        id: "xE7jOejl9FI",
                        code: null,
                    ...
                    cogsDimensionConstraints: [],
                    catDimensionConstraints: [],
                    lastLogin: "2025-03-27T19:39:03.637",
                    selfRegistered: false,
                    invitation: false,
                    disabled: false,
                    surname: "Abebe",
            ...
            userGroups: [
                {
                    ...
                    created: "2021-03-18T11:52:17.427",
                    lastUpdated: "2021-03-18T11:58:32.369",
                    translations: [],
                    createdBy: {
                        id: "GOLswS44mh8",
                        code: null,
        ...
        sixth: {
            trackedEntityTypes: [getTrackedEntityTypeMetadata()],
        },
        seventh: {
            ...
            users: [
                {
                    ...
                    lastUpdated: "2025-03-27T19:47:41.267",
                    translations: [],
                    createdBy: {
                        id: "GOLswS44mh8",
                        code: null,
                    ...
                    cogsDimensionConstraints: [],
                    catDimensionConstraints: [],
                    lastLogin: "2025-03-27T19:47:41.267",
                    selfRegistered: false,
                    invitation: false,
                    disabled: false,
                    surname: "Wakiki",
        ...
        fourteenth: {
            trackedEntityAttributes: [getTrackedEntityAttributeMetadata()],
        },
        fifteenth: {
            users: [
                {
                    name: "Tom Wakiki",
                    created: "2012-11-21T12:02:04.303",
                    lastUpdated: "2025-03-27T19:47:42.277",
                    translations: [],
                    createdBy: {
                        id: "GOLswS44mh8",
                        code: null,
                    ...
                    cogsDimensionConstraints: [],
                    catDimensionConstraints: [],
                    lastLogin: "2025-03-27T19:47:42.277",
                    selfRegistered: false,
                    invitation: false,
                    disabled: false,
                    surname: "Wakiki",
...
export function getProgramTypeExpectedPayload(options: {
    includeObjectsAndReferences: boolean;
    includeOnlyReferences: boolean;
