...
export const ExcludeIncludeRulesModel: Codec<ExcludeIncludeRules> = Schema.object({
    ...
    includeOnlyReferencesRules: Schema.optionalSafe(Schema.array(Schema.string), []),
    includeReferencesAndObjectsRules: Schema.optionalSafe(Schema.array(Schema.string), []),
});
