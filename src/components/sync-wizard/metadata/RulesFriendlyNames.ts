const includeExcludeRulesFriendlyNames: {
    ...
    "programStages.dataElements.dataElementGroups.dataElements": "Data elements of data element groups of data elements in program stages",
    "programStages.dataElements.dataElementGroups.dataElementGroupSets.dataElementGroups": "Data element groups of data element group sets of data element groups of data elements in program Stages",
    ...
    "programStages.dataElements.categoryCombos.attributes": "Attributes of category combinations of data elements in program stages",
    "programStages.dataElements.categoryCombos.categoryOptionCombos": "Category option combinations of Category combinations of data elements in program stages",
    "programStages.dataElements.categoryCombos.categoryOptionCombos.categoryOptions": "Category options of Category option combinations of Category combinations of data elements in program stages",
    "programStages.dataElements.categoryCombos.categories": "Categories of category combinations of data elements in program stages",
    ...
    "trackedEntityTypes.trackedEntityAttributes.legendSets": "Legends of tracked entity attributes of tracked entity types",
