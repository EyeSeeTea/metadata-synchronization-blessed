...
class LandingPage extends React.Component {
    ...
    render() {
        ...
        const items = [
            ...
            ["sync/organisationUnits", i18n.t("Organisation Units Sync"), "sync"],
            ["sync/dataElements", i18n.t("Data Elements Sync"), "sync"],
            ["sync/indicators", i18n.t("Indicators Sync"), "sync"],
            ["sync/validationRules", i18n.t("Validation Rules Sync"), "sync"],
